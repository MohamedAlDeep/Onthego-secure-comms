...
export default async function Navbar(){
    ...
    return (
        ...
        <div className="flex justify-between items-center px-4 m-1 text-white w-130">    
            <a href="/dashboard" className="rounded-[11px] px-3 mx-5 transition-all duration-300 ease-in-out hover:bg-[#BD2ABA]" style={{ borderTop: '2px solid transparent', borderLeft: '2px solid transparent', borderRight: '2px solid transparent', borderBottom: '2px solid #BD2ABA' }}>Dashboard</a>
